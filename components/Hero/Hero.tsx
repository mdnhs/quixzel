...
const Hero = (props: HeroProps) => {
  return (
    <div className="h-screen w-full container space-y-14 pt-20">
      <p className="text-[96px] font-title text-center leading-none">
        Developer partners <br /> of
        <span className=" text-secondary"> creative souls</span>.
      </p>
      <p className="font-bold text-tertiary text-center text-2xl">
      ...
      <div className="w-full flex justify-center items-center gap-10">
        <button className="px-10 py-2 text-2xl font-bold rounded-full bg-secondary text-white relative group hover:-translate-y-3 transition-all duration-300 ease-in-out">
          {" "}
        ...
        <button className="px-10 py-2 text-2xl font-bold rounded-full bg-white border-[3px] border-tertiary text-tertiary relative group hover:-translate-y-3 transition-all duration-300 ease-in-out">
          {" "}
